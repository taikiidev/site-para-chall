    ...
    <>
      <div className="bg-home-bg bg-cover py-4 h-screen w-full flex flex-col items-center">
        <div className="font-modak flex justify-center items-center h-60">
          <h1 className="text-5xl text-yellow-300 text-center sm:text-7xl">Amigos da Saúde!</h1>
        </div>
        ...
        <div className="flex justify-center w-5/12">
          <h1 className="text-4xl font-modak mt-12 mb-14 text-white text-center">Explore novos vídeos!</h1> 
        </div>

        <div className="flex justify-between gap-5">
          <div>
            <iframe width="320" className="border-dashed" height="280" src="https://www.youtube.com/embed/SS4HMzDs2Bc" title="ICr lança manual lúdico para crianças internadas" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
          </div>
